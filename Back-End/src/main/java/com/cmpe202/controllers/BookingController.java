...
public class BookingController {
	...
	public ResponseEntity updateBookingById(@PathVariable Long id, @Valid @RequestBody BookingRequest bookingRequest) {
		...
		return new ResponseEntity(new MessageResponse("Booking Information Updated"),HttpStatus.OK);
	}
	...
	public ResponseEntity addBooking(@Valid @RequestBody BookingRequest bookingRequest) {
		Boolean isLoyal = bookingService.addBooking(bookingRequest);
		return new ResponseEntity(new MessageResponse(String.valueOf(isLoyal)), HttpStatus.OK);
	}
