            ...
            <div className="container-fluid ">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" activeClassName="active_class" exact to="/hotels">Hotels</NavLink>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" activeClassName="active_class" exact to="/admin"></NavLink>
                        </li>
